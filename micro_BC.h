...
SC_MODULE(micro_BC){
	...
	sc_signal< sc_uint<8> >  data_WB_sg, alu_sg;
	sc_singal< sc_uint<4> > dir_WB_sg, reg_memory_inst, reg_memory_data2, reg_memory_data3;
	...
	SC_CTOR(micro_BC){
		...
		alu -> data2(reg_memory_data2);
		alu -> data3(reg_memory_data3);
